            	...
            	<li>
                   ...
                   <div class="cont">
                   	...
                   	<p>
                      	...
                      	<a href="blog-details.php?blog_id=<?=$data[blog_id]?>" class="thumb">
                       <img src="<?=$SERVER_PATH.'uploads/'.$data[blog_image]?>" alt="" style="width:228px; height: 191px; "/></a>
